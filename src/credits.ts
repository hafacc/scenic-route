...
// of the Bay Area. The dialog shows only the active region's, which is also what keeps a licence
...
export const CITY_SOURCES: Record<string, readonly DataSource[]> = {
  nyc: [
    ...
    // CC BY 4.0 makes crediting this a condition of the licence, not a courtesy, and this list is
